            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td class="text-center p-3">
                        <img src="<?php echo htmlspecialchars($row['image_url']); ?>" alt="<?php echo htmlspecialchars($row['name']); ?>" class="w-40 h-20" download>
                    </td>
                    <td>
                ...
                <div x-show="openTab === 2" class="p-6 bg-gray-50 rounded-lg shadow-md">
                    <form action="addProduct.php" method="POST" class="space-y-6" enctype="multipart/form-data">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="name" required class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
                        </div>
                        <div class="space-y-2">
                            <label class="block text-lg font-semibold text-gray-800">Description:</label>
                            <textarea name="description" class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></textarea>
                        </div>
                        <div class="mb-4">
        ...
        <div class="flex space-x-4 mt-2">
            ...
            <label class="flex items-center"><input type="radio" name="size" value="XXL" class="mr-2" /> XXL</label>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="number" name="price" step="0.01" required class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
                        </div>
                        <div class="space-y-2">
